...
void print_txt(const double h, double xi, const double xf, std::array<double, 2>& Ys);
...
void solveRK4(const double h, double xi, const double xf, std::array<double, 2>& Ys){
	...
	double k[2][4+1] = {0.0}; //last collumn used for the sum of the slopes
	//std::array<std::array<double, 4+1>, 2> k;

	std::cout << "n = " << n << ", x0 = " << xi << ", xf = " << xf << ", y0 = " << Ys[0] << ", z0 = " << Ys[1]  << std::endl;
...
void print_txt(std::array<double, 2>& Ys){
